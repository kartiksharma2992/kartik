...
rules
inspect (rules[1:5])
# lhs when purchased people tend to buy RHS with a support of .00xxxx
#multipy support by total values to get the count of number of transactions
#value of lift should be more than 1 for a strong relation
